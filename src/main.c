/*
Computational code for analysis and optimization of a polygeneration system harnessing solar energy for electrical power and freshwater production

Contributors:
Kleber Marques Lisboa, Laboratory of Thermal Sciences (LATERMO), Universidade Federal Fluminense

Acknowledgements:
This work was funded by Petrogal do Brasil S.A.
*/

static char help[] = "Water desalination and electricity polygeneration plant analysis (steady state)\n\n"
"Computational code for analysis and optimization of a polygeneration system harnessing solar energy for electrical power and freshwater production.\n\n"
"Developer: Prof. Kleber Marques Lisboa, UFF\n\n"
"Funding: Petrogal do Brasil S.A.\n\n"
